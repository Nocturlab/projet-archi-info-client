...
/**
 * Class main will initiate and control the main interface
 */
class Main{
    ...
    constructor(remote_url, html_element){
        ...
        if(!this.html_element.classList.contains('main'))
            this.html_element.classList.add('main');
    }
 ...
 * You doesn't need to care of it later in the main development.
 * 
